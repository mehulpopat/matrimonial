					...
					<div class="cd-dropdown-wrapper">
						...
						<nav class="cd-dropdown">
							...
							<ul class="cd-dropdown-content">
								...
								<!-- .has-children -->
								<li class="has-children"><a href="products2.html">Religion</a>
									<ul class="cd-secondary-dropdown is-hidden">
										<li class="go-back"><a href="#">Menu</a></li>
					...
					<nav class="navbar nav_bottom" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav nav_1">
								...
								<li class="${page == 'Home' ? 'active' : ''}"><a href="${pageContext.request.contextPath}/Home">Home</a></li>
								<li class="${page == 'About' ? 'active' : ''}"><a href="${pageContext.request.contextPath}/About">About</a></li>
